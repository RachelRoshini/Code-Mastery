...
<div id="wrapper">
     <!-- Navigation -->
	   ...
	   <div class="xs">
  	 <h3 style="text-align:center;"><b><i>View Course</i></b></h3>
    ...
    @if($key->Status == 1)
        ...
        <button onclick="window.location.href='{{ url('/reject', ['id' => $key->Id]) }}';"  class="btn btn-info">Reject</button>
    @elseif($key->Status == 2)
        <button onclick="window.location.href='{{ url('/approve', ['id' => $key->Id]) }}';" class="btn btn-info">Approve</button>
