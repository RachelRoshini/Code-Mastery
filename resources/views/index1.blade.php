...
<script>window.location='{{url('/userlogin')}}';</script>
@endif
<!doctype html>
<html lang="en">
  <head>
	...
	<header id="site-header">
		<div class="container">
            ...
            <li class="nav-item @@services__active">
						...
						<li class="nav-link">{{session('email')}}</li>
					</ul>
                    ...
                    <div class="course-card">
                        ...
                        <div class="img-box">
                            ...
                            <div class="blog-date">
								...
								<button type="button" class="btn btn-primary" onclick="window.location.href='{{ url('/joincourse', ['id' => $key->Id]) }}'">More details</button>
