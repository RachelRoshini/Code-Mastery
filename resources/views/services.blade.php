                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top ">
                    <div class="color-white editContent">
                        ...
                        <h5><a href="#link" class="editContent">
                                best Teachers</a></h5>
                        <p class="para editContent"><i>Get inspired by the best teachers, committed to making learning engaging and effective</i></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top ">
                    <div class="color-white editContent">
                        ...
                        <h5><a href="#link" class="editContent">Book library</a></h5>
                        <p class="para editContent"><i>Explore our extensive book library, filled with resources to support your learning journey</i></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top ">
                    <div class="color-white editContent">
                        <div class="icon-back"> <span class="fa fa-laptop"></span></div>

                        <h5><a href="#link" class="editContent">Online Courses</a></h5>
                        <p class="para editContent"><i>Browse our wide range of online courses, designed to fit your schedule and learning style</i></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top ">
                    <div class="color-white editContent">
                        <div class="icon-back"> <span class="fa fa-pencil-square-o"></span></div>

                        <h5><a href="#link" class="editContent">
                                Best Certificate</a></h5>
                        <p class="para editContent"><i>Get the best certificate that opens doors to new opportunities and professional growth</i></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top ">
                    <div class="color-white editContent">
                        ...
                        <h5><a href="#link" class="editContent">Best Discount</a></h5>
                        <p class="para editContent"><i>Take advantage of the best discount and start learning today at an unbeatable price</i> </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top ">
                    <div class="color-white editContent">
                        <div class="icon-back"><span class="fa fa-user"></span></div>
                        <h5><a href="#link" class="editContent">Qualified Staff</a></h5>
                        <p class="para editContent"><i>Our qualified staff is dedicated to providing expert guidance and support every step of the way</i></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="service-single-page editContent">
        <div class="container">
              <div class="service-grids row">
                <div class="col-lg-6 ">
                  <img src="{{url('public/assets/images/b1.jpg')}}" alt="product" class="img-responsive about-me">
                </div>
                <div class="cwp4-text col-lg-6 text-left pl-lg-5 align-self">
                  <h6 class="small-title">New courses</h6>
                    <h3>Learning the importance of right courses. </h3>
                  <p class="para editContent text ">
                    <i>Learning the importance of choosing the right courses can shape your future. Pick the right path to achieve your goals and unlock your potential.</i></p>
              ...
              <div class="service-grids row pb-0">
                <div class="service-grid col-lg-6 text-left pr-lg-5 align-self ">
                  <h6 class="small-title">Boost Your Skills</h6>
                    <h3>One of a kind learning opportunities</h3>
                  <p class="para editContent text ">
                   <i>Discover one-of-a-kind learning opportunities designed to unlock your full potential. Stand out with skills that make a lasting impact.</i></p>
                    <a href="{{url('/about')}}" class="action-button btn mt-lg-5 mt-4">Read more</a>
                  </div>
                  <div class="cwp4-text col-lg-6 ">
                    <img src="{{url('public/assets/images/b8.jpg')}}" alt="product" class="img-responsive about-me">
                  </div>
              </div>
    </div>
</div>
