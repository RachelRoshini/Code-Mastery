...
<section class="w3l-contact-info-main" id="contact" >
       ...
       <h2 style="text-align:center;color:white;margin-bottom:25px;margin-top:20px;">Register</h2>
        <div class="container" >
                ...
                <div class="map-content-9" >
                    <form  action="{{url('/register_action')}}" method="post" enctype="multipart/form-data" onsubmit="return validatePassword()">
                        
                            <input type="text"  class="form-control" name="name" id="name" placeholder="Name" required="">
                            <input type="number"  class="form-control" name="phoneno" id="phoneno" placeholder="Whatsapp No" required="">
