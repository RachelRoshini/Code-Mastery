     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="{{url('public/assets/admin/images/1.png')}}" alt=""/><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3 style="text-align:center;"><b><i>Edit</i></b></h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="{{ url('/updatedetails')}}" method="post" enctype="multipart/form-data">
                        
									
									
										<input type="hidden" value="{{$editdata->Id}}" class="form-control1" id="id" name="id">
									
								<div class="form-group">
									<label for="course" class="col-sm-2 control-label"><b><i>Course Name</i></b></label>
									<div class="col-sm-8">
										<input type="text" value="{{$editdata->Coursename}}" class="form-control1" id="course" name="course">
									</div>
								</div>
								<div class="form-group">
									<label for="logo" class="col-sm-2 control-label"><b><i>Image</i></b></label>
									<div class="col-sm-8">
										<input type="file" value="{{$editdata->Image}}"class="form-control1" id="image" name="image">
                                        <img src="{{ url('public/assets/admin/docimages/'.$editdata->Image) }}" width="100px" height="50px">
									</div>
								</div>
								<div class="form-group">
									<label for="duration" class="col-sm-2 control-label"><b><i>Duration</i></b></label>
									<div class="col-sm-8">
										<input type="text" value="{{$editdata->Duration}}" class="form-control1" id="duration" name="duration">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" value="{{$editdata->Time}}" class="form-control1" id="time" name="time">
									</div>
								</div>
								<div class="form-group">
									<label for="instructor" class="col-sm-2 control-label"><b><i>Instructor</i></b></label>
									<div class="col-sm-8">
										<input type="text" value="{{$editdata->Instructor}}" class="form-control1" id="instructor" name="instructor">
									</div>
								</div>
								<div class="form-group">
									<label for="coursefees" class="col-sm-2 control-label"><b><i>Course Fees</i></b></label>
									<div class="col-sm-8">
										<input type="number" value="{{$editdata->Coursefees}}"class="form-control1" id="coursefees" name="coursefees">
									</div>
								</div>
