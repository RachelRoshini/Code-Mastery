    ...
    <div class="about-inner blog-single editContent">
        ...
        <div class="breadcrumbs-sub">
            <ul class="breadcrumbs-custom-path">
                <li class="right-side propClone"><a href="{{url('/index1')}}" class="editContent">Home <span class="fa fa-angle-right" aria-hidden="true"></span></a> <p></li>
        ...
        <div class="container">
            ...
            <div class="d-grid contact-view">
                ...
                <div class="cont-details ">
                    <img src="{{ url('public/assets/admin/docimages/'.$coursedetails->Image) }}" width="100%" height="30%" name="image" style="margin-top:200px;">

                </div>
                <div class="map-content-9 pl-lg-5 ">
                    <form  action="{{url('/courseupdate')}}" method="post" enctype="multipart/form-data">
                        <div class="twice-two">
						<input type="hidden" value="{{$coursedetails->Id}}" class="form-control1" id="id" name="id">
						<input type="hidden" value="{{$coursedetails->Link}}" class="form-control1" id="link" name="link">
						<label for="coursename" style="color:white;">Course Name</label>
                            <input type="text" class="form-control" name="coursename" id="coursename" value="{{$coursedetails->Coursename}}">
                           <label for="duration" style="color:white;">Duration</label>
                            <input type="text" class="form-control" name="duration" id="duration" value="{{$coursedetails->Duration}}"> 
							<label for="time" style="color:white;">Time</label>
                            <input type="text" class="form-control" name="time" id="time" value="{{$coursedetails->Time}}">
							<label for="instructor" style="color:white;">Instructor</label>
                            <input type="text" class="form-control" name="instructor" id="instructor" value="{{$coursedetails->Instructor}}">
							<label for="coursefees" style="color:white;">Course Fee</label>
                            <input type="text" class="form-control" name="coursefees" id="coursefees" value="{{$coursedetails->Coursefees}}">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-contact" onclick="showAlert()">Join Course</button>
                        </div>
                    </form>
...
<script>
        function showAlert() {
            alert("Go and check the course in the menu.");
        }
    </script>
