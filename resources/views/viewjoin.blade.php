...
<div id="wrapper">
     <!-- Navigation -->
	   ...
	   <div class="xs">
  	 <h3 style="text-align:center;"><b><i>Join Course</i></b></h3>
    ...
    @if($key->Status == 1)
        ...
        <button onclick="window.location.href='{{ url('/reject', ['id' => $key->course_id]) }}';" style="margin-top: 10px;" class="btn btn-info">Reject</button>
    @elseif($key->Status == 2)
        <button onclick="window.location.href='{{ url('/approve', ['id' => $key->course_id]) }}';" class="btn btn-info">Approve</button>
