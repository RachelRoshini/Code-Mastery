        ...
        <div class="container">
            ...
            <div class="d-grid contact-view">
                ...
                <div class="cont-details ">
                    ...
                    <p class="para mt-3 mb-4"><i>Don’t hesitate to get in touch with our team to learn more or get started.</i></p>
                    
                    <div class="cont-top ">
                        <h6 class="mt-4 cont-left">Address:</h6>
                        <div class="cont-right">
                            <p class="para mt-1"><i>12th block,
							Maple Building,London, UK.</i></p>
                        </div>
                    </div><div class="cont-top margin-up">
                        <h6 class="mt-4 cont-left">Contact:</h6>
                        <div class="cont-right">
                            <p class="para mt-1"><a href="#phone">+123 45 67 89</a></p>
                            <p class="para"><a href="#phone">+111 45 67 99</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <h6 class="mt-4 cont-left">Email:</h6>
                        <div class="cont-right">
                            <p class="para mt-1"><a href="#mail" class="mail">Codemastery@gmail.com</a></p>
                        </div>
                    </div>
            ...
            <div class="map-iframe mt-lg-5 mt-md-5 mt-sm-5 mt-4 pt-lg-2">
