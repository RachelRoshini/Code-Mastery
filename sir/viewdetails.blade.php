		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				...
				<!--<li class="dropdown head-dpdn">
					...
					<li class="dropdown head-dpdn">
						<a href="{{url('/login_in')}}" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Sign In</a>
					</li>
					<li class="dropdown head-dpdn">
						<a href="{{url('/view_user')}}"><i class="fa fa-question-circle" aria-hidden="true"></i> View Users</a>
					</li>
					<li class="dropdown head-dpdn">
...
<table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
						...
						<tr>
							...
							<td>{{$key->phone}}</td>
							<td>{{$key->email}}</td>
							<td><a href="{{ url('/editdetails/'.$key->user_id) }}">Edit</a></td>
							<td><button class="btn btn-danger btn-del" id="{{$key->user_id}}">Delete</a></td>
